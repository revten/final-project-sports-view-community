...
public class CM_WG_TITLE {
	...
	public CM_WG_TITLE(int wg_no, String wg_id, String wg_title, String wg_content, String wg_img, String wg_video,
			Date wg_date, String wg_cat, int wg_count, int wg_like, String search, int sort, int rnStart, int rnEnd) {
		super();
		this.wg_no = wg_no;
		this.wg_id = wg_id;
