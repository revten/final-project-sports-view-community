...
public class MyPostDTO {
	...
	private List <MyPostComment> mypost_comments;
	...
	public MyPostDTO(int mypost_no, String mypost_nick, String mypost_id, String mypost_title, String mypost_content,
			...
			List<MyPostComment> mypost_comments) {
		super();
		...
		this.mypost_comments = mypost_comments;
	}
	...
	public List<MyPostComment> getMypost_comments() {
		return mypost_comments;
	}

	public void setMypost_comments(List<MyPostComment> mypost_comments) {
		this.mypost_comments = mypost_comments;
	}
