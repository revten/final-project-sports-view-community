...
<div>
	<h3>축구게시판</h3>
	<form action="soccerInsert.do" method="post" enctype="multipart/form-data">
		<table border="1">
			<tr>
				<tr>
					<td>
				탭선택하기 :<select name="cm_sc_cat">
				...
				<tr>
					<td>
						글내용:<textarea name="cm_sc_content" rows="20" cols="20"></textarea>
					</td>
				</tr>
				<tr>
					<td>
						사진<input name="cm_sc_img"  type="file">
						동영상<input name="cm_sc_video"  type="file">
