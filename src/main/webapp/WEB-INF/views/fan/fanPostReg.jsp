...
const srFanR = ScrollReveal({
	...
	srFanR.reveal(`.container-field`);
	srFanR.reveal(`.board-main`, { origin: 'right' });
	srFanR.reveal(`.app-content`, { origin: 'right' });
	srFanR.reveal(`.app-container`, { origin: 'right' });
	srFanR.reveal(`.`, { interval: 100 });
	</script>
