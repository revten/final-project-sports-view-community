...
<body>
	<div class="myPage_container">
      ...
      <path
					...
					</a> <a class="sidebar-link" href="myPage.myPost.go?post_member=${sessionScope.loginAccount.member_id}" style="text-decoration: none"> <svg
							viewBox="0 0 24 24" fill="currentColor">
      <path fill-rule="evenodd" clip-rule="evenodd"
							...
							viewBox="0 0 24 24" fill="currentColor" style="text-decoration: none">
      <path fill-rule="evenodd" clip-rule="evenodd"
      ...
      <path fill-rule="evenodd" clip-rule="evenodd"
		...
		<div class="main-container">
			<div class="modify-container">
				...
				<div>닉네임 &nbsp;
				${sessionScope.loginAccount.member_nick }</div>
				<div>가입일자 &nbsp;
					<fmt:formatDate
				...
				<div>이메일&nbsp;
				${sessionScope.loginAccount.member_email }</div>
				<div>자기소개&nbsp;
				${sessionScope.loginAccount.member_intro }</div>
				<button id="infomation" onclick="location.href='account.modify.go'">내 정보
					수정하기</button>
			</div>
			</div>
		</div>
