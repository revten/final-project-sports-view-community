	...
	<div class="myPage_container">
		<div class="sidebar">
			...
			<div class="side-wrapper">
				<div class="side-menu">
					<a class="sidebar-link discover is-active" href="myPage.main.go">
				...
				<div class="point-container">
					<form action="profile.reg.do" method="post"
						...
						<div class="accountReg__pwInput-2">
							<!-- member 비밀번호 인풋 창 -->
							<input type="password" id="pwInput" name="member_pwd"> <img
								id="questionMark2"
						...
						<!-- member nick 인풋 창 -->
						<div>닉네임</div>
						<input id="member_nick" name="member_nick" value="${sessionScope.loginAccount.member_nick }">
						...
						<textarea name="member_intro" cols="50" rows="10">${sessionScope.loginAccount.member_intro}</textarea>
						<!-- member club 선택 창 -->
						<div>
						...
						<button id="infomation">수정</button>
					</form>
				</div>
			</div>
		</div>
