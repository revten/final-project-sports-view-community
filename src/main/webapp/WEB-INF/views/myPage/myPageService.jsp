     ...
     <path
      ...
      <path fill-rule="evenodd" clip-rule="evenodd"
			...
			<div class="main-container">
						...
						<c:forEach var="ask" items="${Asks }">
							<tr>
								...
								<td><a style="cursor: pointer; color: blue;"
									href="myPage.ask.detail.go?ask_no=${ask.ask_no}">${ask.ask_title }</a></td>
								<td>${ask.ask_date }</td>
								<td>${ask.ask_count }</td>
							</tr>
						</c:forEach>
				...
				<br>
				<button id="infomation" onclick="bye();" type="button">탈퇴문의</button>
				<button id="infomation" type="button">고객문의</button>
			</div>
			</div>
		</div>
		</div>
