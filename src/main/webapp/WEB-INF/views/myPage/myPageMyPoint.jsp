...
<body>
	<div style="float: left; position: absolute; top: 100px; left: 30%;">
		<img src="resources/files/backgroundImg/basketball3.png">
	</div>
	<div style="float: right; position: absolute; top: 400px; left: 57%;">
		<img src="resources/files/backgroundImg/coach2.jpg">
	</div>
	<div style="float: right; position: absolute; top: 550px; left: 7%;">
		<img src="resources/files/backgroundImg/soccer1.png">
	</div>
	<div style="float: right; position: absolute; top: 50px; left: 1%;">
		<img src="resources/files/backgroundImg/mypage1.png">
	</div>
	<div class="myPage_container">
		<div class="sidebar">
			<div class="side-wrapper">
				<div class="side-menu">
					</a> <a class="sidebar-link trending" href="myPage.info.go"
