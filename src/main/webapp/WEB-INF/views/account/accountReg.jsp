	...
	<div id="accountReg__contrainer">
		<form action="account.reg.do" method="post"
			...
			<div class="accountReg__idInput-2">
				<!-- member 아이디 인풋 창 -->
				<input id="idInput" name="member_id" oninput="checkId()"> <img id="questionMark1"
				...
				<input id="idConfirm" type="hidden" value="0"> <br> <span
			...
			<div class="accountReg__emailInput-2">
				<!-- member 이메일 인풋 창 -->
				<input type="email" id="search_member_email" name="member_email">
				<br>
				<button type="button" id="member_email_check">이메일 인증</button>
