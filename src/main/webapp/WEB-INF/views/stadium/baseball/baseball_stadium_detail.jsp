	...
	<div
		...
		<div style="display: inline-block; border: 2px solid red">
			...
			<map name="workmap">
				...
				<area class="imgArea" id="east" coords="364,117,499,371"
					shape="rect">
				<area class="imgArea" id="south" coords="84,373,419,498"
					shape="rect">
			</map>
		</div>

		<img style="visibility: hidden" id="test_east"
			src="resources/files/stadium/baseball/seating_chart/test_e.jpg">
		<img style="visibility: hidden" id="test_west"
			src="resources/files/stadium/baseball/seating_chart/test_w.jpg">
		<img style="visibility: hidden" id="test_south"
			src="resources/files/stadium/baseball/seating_chart/test_s.jpg">
		<img style="visibility: hidden" id="test_north"
