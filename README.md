...
이를 기반으로 커뮤니티형 사이트로 확장시켜 구현해보자는 목표를 설정하였습니다.<br>
<br>
...
* **WithGO / Review**
  * 슬라이드 효과를 통하여 기존 커뮤니티 게시판과는 다른 css의 공간구현<br>
  * The Fan의 게시판 CRUD 구조가 같아 샘플 게시글만 있고 CRUD 구현은 되어있지 않습니다<br>
* **The Fan**
  * 커뮤니티 게시판의 기본에 충실한 구성으로 CRUD 구현<br>
...
## 추가소식
시간적 부족함으로 인하여 기획했던 것보다 구현내용이 부족합니다.
